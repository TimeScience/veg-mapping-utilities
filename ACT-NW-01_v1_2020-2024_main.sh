...
#lon=149.145069
#buffer=0.02
stub=ACT-NW-01_v1_2020-2024
start=2020-01-01
end_=2024-12-31

# NOTE: When "use_geojson=1", lat/lon/buffer are ignored

use_geojson=true # MUST be true or false (lowercasea), not 0,1 or True or False due to stupid issues with how python parses booleans when called by bash

geojson_path=geojson/ACT-NE-v1.geojson
